...
export async function runMigrations(): Promise<void> {
  ...
  await db.query(`
    ...
    DEFINE FIELD IF NOT EXISTS source_file ON business_fact TYPE option<record<file>>;
    ...
    DEFINE INDEX IF NOT EXISTS business_fact_source_type_idx
      ON business_fact FIELDS source_type;
    DEFINE INDEX IF NOT EXISTS business_fact_source_file_idx
      ON business_fact FIELDS source_file;
  ...
  await db.query(`
    ...
    DEFINE FIELD IF NOT EXISTS source_file ON memory_chunk TYPE option<record<file>>;
    ...
    DEFINE INDEX IF NOT EXISTS memory_chunk_source_type_idx ON memory_chunk FIELDS source_type;
    DEFINE INDEX IF NOT EXISTS memory_chunk_source_file_idx ON memory_chunk FIELDS source_file;
  ...
  await db.query(`
    ...
    -- File -> fact provenance (Day-0 bootstrap)
    ...
    -- PR -> file traceability (PR ingestion)
